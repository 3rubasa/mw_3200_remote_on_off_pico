...
const struct fsdata_file file_state_shtml[] = {{ NULL, data_state_shtml, data_state_shtml + 13, sizeof(data_state_shtml) - 13, FS_FILE_FLAGS_HEADER_INCLUDED | FS_FILE_FLAGS_HEADER_PERSISTENT}};
